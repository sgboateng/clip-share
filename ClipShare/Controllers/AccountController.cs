    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(Register_vm model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (await CheckNameExistsAsync(model.FullName))
                {
                    ModelState.AddModelError("Name", $"The name '{model.FullName}' is taken. Please try another name.");
                ...
                {
                    ModelState.AddModelError("Name", $"The User name of '{model.Username}' is taken. Please try another name.");
